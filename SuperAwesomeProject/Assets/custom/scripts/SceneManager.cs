...
public class SceneManager : MonoBehaviour {
	...
	void Start () {
		terrainChunk1= (GameObject)GameObject.Instantiate(terrainChunk,new Vector3(0,0,0),new Quaternion());
		terrainChunk2 = (GameObject)GameObject.Instantiate(terrainChunk,new Vector3(1000,0,0),new Quaternion());
	}
